...
επίπεδο, η αγοραστική δύναμη και η οικονομική ασφάλεια της κοινωνίας. Το
πολιτικό σημείο που προκύπτει από αυτά τα ευρήματα είναι απλό: δεν
μπορούμε να επικαλούμαστε τους δείκτες για να πιστοποιούμε την ανάκαμψη
και, όταν η εμπειρία των νοικοκυριών διαφωνεί, να μεταφέρουμε αυτόματα
την ευθύνη στην ψυχολογία και στις επιλογές τους. Αυτή η τελική σύνθεση
είναι ερμηνεία των συγγραφέων και όχι νέο εμπειρικό αποτέλεσμα: προκύπτει
άμεσα από όσα έδειξε η ανάλυση ότι χάνει ο AROP από μόνος του, όχι από
κάποιον επιπλέον έλεγχο.</p>
