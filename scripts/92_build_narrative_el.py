...
<p>Για να καταλάβουμε αυτή την απόκλιση, πρέπει πρώτα να δούμε τι ακριβώς
μετρά ο καθένας από τους δύο δείκτες. Ο επίσημος <em>δείκτης εισοδηματικής
φτώχειας</em>, ο «κίνδυνος φτώχειας» ή <em>AROP</em>, μετρά τη σχετική
εισοδηματική θέση: ένα άτομο θεωρείται ότι βρίσκεται σε κίνδυνο φτώχειας
όταν το ισοδύναμο διαθέσιμο εισόδημα του νοικοκυριού του πέφτει κάτω από το
60% του διάμεσου εθνικού εισοδήματος, με το όριο αυτό να επανυπολογίζεται
κάθε χρόνο. Η <em>δηλωμένη οικονομική δυσκολία</em> μετρά κάτι διαφορετικό.
Στην πανευρωπαϊκή έρευνα EU-SILC, τα νοικοκυριά ερωτώνται πόσο εύκολα
μπορούν να τα βγάλουν πέρα και όσα απαντούν «με δυσκολία» ή «με μεγάλη
δυσκολία» καταγράφονται εδώ ως <em>νοικοκυριά που αντιμετωπίζουν οικονομική
δυσκολία</em>. Ο ένας δείκτης, επομένως, τοποθετεί το εισόδημα ενός
νοικοκυριού σε σχέση με τα υπόλοιπα· ο άλλος καταγράφει αν το ίδιο το
νοικοκυριό θεωρεί ότι οι πόροι του επαρκούν για την καθημερινότητά του.</p>

<p>Οι δύο δείκτες δεν θα έπρεπε να ταυτίζονται, αλλά θα περιμέναμε να
συνδέονται: όσο αυξάνεται η οικονομική φτώχεια, τόσο περισσότερα νοικοκυριά
θα έπρεπε γενικά να δυσκολεύονται να τα βγάλουν πέρα. Στην Ελλάδα, όμως, η
απόσταση μεταξύ τους είναι ασυνήθιστα μεγάλη. Εκεί βρίσκεται το βασικό
ερώτημα αυτού του κειμένου: γιατί η επίσημη εισοδηματική φτώχεια και η
δηλωμένη οικονομική δυσκολία αποκλίνουν τόσο έντονα; Μήπως τα ελληνικά
νοικοκυριά τείνουν να περιγράφουν την κατάστασή τους πιο απαισιόδοξα ή μήπως
ο επίσημος δείκτης φτώχειας αφήνει έξω ένα σημαντικό μέρος της οικονομικής
πίεσης που πράγματι βιώνουν;</p>
...
καρτέλα, «Βασικοί δείκτες», ο <em>AROPE</em> βρίσκεται ανάμεσα στην
εισοδηματική φτώχεια και την οικονομική δυσκολία, αλλά πολύ πιο κοντά στην
πρώτη.</p>
...
<p>Τρεις από τις τέσσερις καρτέλες του Γραφήματος {{fig:F8}} λένε την ίδια
...
<p>Η τέταρτη καρτέλα, «Καθυστερήσεις σε λογαριασμούς», διαφέρει και αξίζει να
...
<p>Τα στοιχεία δείχνουν ότι η δηλωμένη οικονομική δυσκολία κινείται μαζί με
συγκεκριμένες υλικές στερήσεις. Επειδή όμως όλα προέρχονται από την ίδια
έρευνα, δεν αρκούν για να επιβεβαιώσουν ανεξάρτητα ότι οι απαντήσεις των
νοικοκυριών αντανακλούν πραγματική οικονομική πίεση και όχι έναν κοινό
τρόπο αρνητικής απάντησης.</p>

<p>Αυτό που μπορούμε να πούμε είναι ότι η δηλωμένη οικονομική δυσκολία
κινείται μαζί με συγκεκριμένες υλικές δυσκολίες. Δεν μπορούμε όμως να
πούμε, μόνο από αυτά τα στοιχεία, ότι επιβεβαιώνεται από μια εντελώς
ανεξάρτητη πηγή. Γι' αυτό χρειάζεται και ένας δεύτερος έλεγχος, με
διαφορετικά δεδομένα. Αν η οικονομική δυσκολία ήταν απλώς αποτέλεσμα του
τρόπου με τον οποίο διατυπώνεται ή απαντιέται αυτή η συγκεκριμένη ερώτηση,
θα περίμενε κανείς να μην ταιριάζει με την ευρύτερη εικόνα της ελληνικής
οικονομίας. Όμως ταιριάζει.</p>
...
<p>Η δεύτερη καρτέλα, «Πόσοι δείκτες», συμπυκνώνει αυτή την εξάπλωση σε μία
γραμμή. Πριν από την κρίση, η Ελλάδα βρισκόταν στο χειρότερο πέμπτο της ΕΕ
...
πραγματική, γιατί ο επίσημος δείκτης φτώχειας την καταγράφει τόσο λίγο;</p>
"""))
...
στους υλικούς πόρους και στην αγοραστική δύναμη είτε έκλεισαν ελάχιστα
...
παρουσιάζει τις ίδιες μεταβολές στις μονάδες κάθε δείκτη. Οι υλικοί πόροι
μετριούνται σε μονάδες αγοραστικής δύναμης (ΜΑΔ): μια κοινή τεχνητή
...
βελτιώνεται χωρίς να κλείνει το χάσμα από την Ευρώπη. Οι υλικοί πόροι
αυξήθηκαν σημαντικά στην Ελλάδα, αλλά έμειναν ακόμη πιο πίσω επειδή η
...
{{fig:F10}}, η μακροχρόνια ανεργία, οι υλικοί πόροι και η <em>αγοραστική
...
{context_el('CTX-8', "επιπλέον στοιχεία από άλλη πηγή",
    ...
    "Η εικόνα συμφωνεί με τα ευρήματα για τους υλικούς πόρους και την "
...
χρησιμοποιηθεί. Η πρώτη αφορά τους υλικούς πόρους: τα διαθέσιμα δεδομένα
...
{finding_el('V2-5.Z', "Οι συσσωρευμένοι υλικοί πόροι δεν μπόρεσαν καν "
            "να ελεγχθούν: τα διαθέσιμα δεδομένα ξεκινούν το 2015 και δεν "
...
μισθούς, στους υλικούς πόρους και στην αγοραστική δύναμη. Βρήκαμε επίσης
...
η απασχόληση, οι υλικοί πόροι ή το ευρύτερο καλάθι δεικτών, δεν έχουν αυτό
...
κατάσταση στην εργασία, στους υλικούς πόρους και στην αγοραστική δύναμη
προσθέτει πληροφορία που ο AROP από μόνος του δεν καταγράφει. Υπάρχουν
επίσης ενδείξεις ότι, σε ορισμένους τομείς, σημασία έχει όχι μόνο η
σημερινή κατάσταση αλλά και το βάρος που συσσωρεύτηκε στη διάρκεια της
κρίσης.</p>
...
<p>Τα αποτελέσματα δεν στηρίζουν την απλή εξήγηση ότι η δηλωμένη οικονομική
δυσκολία είναι μόνο απαισιοδοξία ή στατιστικός θόρυβος. Οι απαντήσεις των
νοικοκυριών συμβαδίζουν με συγκεκριμένες υλικές στερήσεις και εντάσσονται
σε ένα ευρύτερο μοτίβο οικονομικού μειονεκτήματος. Αυτό δεν σημαίνει ότι
...
<p>Ο επίσημος δείκτης φτώχειας, λοιπόν, δεν είναι λάθος. Ο AROP μετρά
