...
| Branch | `main` |
| HEAD | `7897638` Add X-05: fact-check of Kyranakis deposit/spending claims on household strain |
...
| X-02 | 2026-09-14 | parallaximag.gr (14 Sep 2026): Greece is the 2nd-worst of 10 surveyed countries on nearly every poverty/insecurity indicator, behind only Moldova, per the 20th Ipsos/Secours Populaire "Baromètre de la pauvreté et de la précarité" — [archived URL](https://parallaximag.gr/epikairotita/greece/varometro-ftocheias-h-ellada-katalamvanei-ti-deyteri-cheiroteri-thesi-schedon-se-oloys-toys-deiktes) | Traced past the news write-up to the primary source: [the 97-page PDF report](https://www.secourspopulaire.fr/app/uploads/2026/09/barometre-ipsos-pauvrete-et-precarite-20e-edition-2026.pdf), Ipsos for Secours Populaire Français, June 2026, ISO 20252-compliant. Methodology confirmed directly from the report: 10,000 respondents, exactly 1,000 per country in 10 countries (France, Germany, Greece, Italy, Poland, UK, Moldova, Portugal, Romania, Serbia), recruited from Ipsos's online access panel with quota sampling on sex/age/occupation/region/agglomeration (not full probability sampling), fieldwork 6 May – 9 June 2026. This is a different kind of source from anything else in this project: a privately commissioned omnibus perception survey, not an EU-SILC or other Eurostat statistical product, and its "European average" is an unweighted mean across these 10 national samples of 1,000 each — three of which (UK, Moldova, Serbia) are not EU member states, so it is **not** comparable to a Eurostat EU-27 aggregate despite the "European" framing. Verified the article's headline number against the report itself: Greece's 44% (vs. a 29% ten-country average) is the share answering "Précaire" to "how would you describe your current financial and material situation" (defined in the questionnaire as: an unexpected expense could tip you over) — the report's own three-point self-rated scale, not an income threshold. At n=1,000 per country the report's own confidence-interval table puts this at roughly ±3 points (95% CI). No downloadable microdata was found; the report's annexes describe only its quality/methodology controls, not a public dataset — the PDF's aggregated percentages are the only artifact available. Relationship to this project's own figures: this is directionally consistent with, but not the same measurement as, either of this project's headline indicators — AROP (19.6%, 2024, an income-threshold measure) or subjective poverty (66.7%, 2024, EU-SILC's own single self-rated financial-difficulty item). The Ipsos "précaire" share (44%) and the EU-SILC subjective-poverty rate (66.7%) ask different questions of different populations under different sampling frames and are not interchangeable or addable; both point the same direction (Greek respondents report financial distress well above the country's own income-poverty rate, and above most European peers on self-report measures specifically), which is as far as this comparison can honestly go. | checked, not incorporated — informational only, no claim, context entry, or figure affected |
| X-03 | 2026-09-14 | greekonomics.gr (14 Sep 2026), "Η βιομηχανία του τζόγου" [The gambling industry] — [archived URL](https://greekonomics.gr/plot85/), plus a reader-supplied follow-up analysis of Greek gambling participation and problem-gambling data | The article's headline figures reproduce against its cited source: online gambling gross gaming revenue (GGR) roughly doubled from €0.59bn (2020) to €1.19bn (2025), traditional (land-based) GGR rose from €1.04bn to €1.88bn over the same window, and the combined regulated market reached €3.073bn in 2025 (+6.74% on 2024), 38.8% of it online — all sourced to ΕΕΕΠ (the Hellenic Gaming Commission) performance reports. A follow-up comparison, checked against its own cited sources, situates this internationally: in H2 Gambling Capital's 2024 comparative table (16 countries, not all 27 EU states, via [OPAP's own investor reproduction of it](https://media.opap.gr/investors/OPAP_Dec_2025.pdf)), Greek GGR was 1.24% of GDP against a 0.71% table average — 2nd of the 16, behind only Cyprus (1.75%) — and €379 GGR per adult, 5th of the 16 behind Cyprus, Ireland, Italy and Croatia. Because the table omits 11 EU states, "Greece has the EU's highest gambling market" is not a claim this table can support, and the reader's own write-up is explicit on that point. Separately, ΕΕΕΠ's own 2025 participation survey (Pulse RC, n=2,001, CATI/CASI/CAWI, early 2025) was checked directly and reproduces exactly: 54.5% of Greek adults played some game of chance; 2.6% of the whole adult population scored high-risk on the Problem Gambling Severity Index; and, the figure most relevant here, **problem-gambling behaviour was reported by 9% of those describing their own financial situation as difficult, against 2% of those describing it as comfortable** — a roughly 4.5x gradient. This is independent of this project's own pipeline in a way X-01 and X-02 are not: a different Greek population survey (ΕΕΕΠ/Pulse RC), a different institution, and a different instrument from EU-SILC, converging on the same pattern this project's own V2-3.1 established from EU-SILC material-difficulty items alone (reported hardship co-moving with concrete material strain). As the reader's own write-up states plainly: GGR is not evidence of prosperity — it is the industry's take from money players net-lose before costs and tax, so a high GGR/GDP ratio is a large economic burden, not proof "there's money to spare"; and Greece's relatively small GDP mechanically inflates any revenue-to-GDP ratio computed against it. No fully harmonised EU-wide participation or problem-gambling survey exists, so no cross-country rank claim beyond the 16-country GDP-ratio table above is supportable. Promoted to context register as CTX-12, linked to V2-3.1, using the 9%-vs-2% finding specifically. | checked; the financial-situation gambling-risk finding promoted to context register as CTX-12 |
| X-04 | 2026-09-14 | Facebook post (EESC — European Economic and Social Committee, 14 Sep 2026): "In 2025, 29% of workers across the EU said they had experienced stress, depression or anxiety caused or made worse by their work, with major differences between EU countries" — citing EU-OSHA's Flash Eurobarometer "OSH Pulse 2025" — no country-level figure given in the post itself | The EU-wide figure checks out exactly against EU-OSHA's own materials: 29% of EU27 workers report work-related stress, depression or anxiety in the last 12 months (n=25,688 for the EU27-only infographic; the fuller country table draws on n=28,220 across EU27 plus Iceland, Norway and Switzerland, 30 countries in total, fieldwork 31 March–14 April 2025). The post itself, and the two EU-OSHA pages that summarise it, give only this EU-wide figure — no Greek number, despite the comment thread's strong implication that Greece topped the ranking ("An other Greek Tragedy!", "At least we are first in something here in GREECE..."). That implication turned out to be correct and, if anything, understated: EU-OSHA's full OSH Pulse 2025 report (not the post, not the highlights page, not the infographic — none of those three carry a country breakdown) gives a complete 30-country table (Table 21, Question C1) in which Greece scores **49%** on work-related stress, depression or anxiety — the highest of all 30 countries surveyed, 20 points above the EU27 average, and up from 37% in the prior (April–May 2022) wave, the largest increase of any country in the table. Next-highest: Finland (45%), Cyprus and Poland (41% each), Spain (40%); lowest: Denmark (19%). Relationship to this project's own findings: this is a third, independent domain — after financial hardship/expectations and (to a lesser degree) life satisfaction — in which Greece sits at the extreme of a self-report EU ranking, extending the pattern this project's own CTX-1 and V2-7.1 already established from its own reporting-style comparison. It does not resolve the question V2-7.1 leaves open (domain-specific circumstance vs. a broader reporting tendency), since workplace stress is itself self-reported and would carry the same tendency if one exists; a third domain moving the same way is one more data point on either reading, not a tiebreaker. Promoted to context register as CTX-13, linked to V2-7.1, alongside CTX-1. | checked; promoted to context register as CTX-13 |
| X-05 | 2026-09-15 | Facebook video (Documento, 14 Sep 2026), Κωνσταντίνος Κυρανάκης (ND party secretary) on Action24, disputing that "the average salary runs out by the 20th of the month": cites card-transaction data showing spending falls only ~3% in the month's 4th week vs. the 1st, and a "~€40bn" rise in bank deposits concentrated in accounts of €5,000–50,000, offered as evidence households are not under real strain — [archived URL](https://fb.watch/v/5iXOEilZu/) | The statement itself is well documented — a second such exchange with a different journalist in days, independently covered by efsyn.gr, protothema.gr and news.gr, not just Documento. The two supporting figures do not hold up as stated. **The deposit figure conflates two different things.** Bank of Greece/TEKE data (via protothema.gr and iefimerida.gr coverage of the same underlying dataset, previously cited by a government minister, Α. Σκέρτσος) shows total individual deposits rose from €106.4bn to €148.7bn, Dec 2018–2025 (+€42.3bn, +39.8%, all account sizes combined) — this is the actual source of the "~€40bn" figure. The €5,000–50,000 bracket specifically, the one Kyranakis named as "the middle class," rose only **€13.8bn** (2019–2025, €47.17bn→€60.97bn, +29.3%) to **€16.0bn** (2018–2025, per the Skertsos breakdown) — roughly a third of the figure attributed to it. TEKE's own data additionally counts eligible depositors per bank, not unique individuals, so a person with accounts at several banks is counted more than once, which the government's own presentation of this data acknowledges as a caveat. **The card-spending figure traces to a real source** (Michalis Argyrou, head of the PM's Economic Bureau, Bank of Greece card-transaction data, Jan 2023–Jun 2026, reported as a 3.4% week-4-vs-week-1 decline, not exactly 3%) but a same-day critique (dnews.gr) raises a specific, checkable problem with the inference drawn from it: the data is not broken down by income level, so a low earner cutting spending sharply and a high earner spending normally can average out to a small aggregate decline, and card-transaction totals cannot distinguish reduced spending from reduced saving or from spending funded by revolving credit -- none of which "salary doesn't run out" actually rules out. One figure in that critique piece (86.2% of Greek households having difficulty making ends meet in 2024, cited to Eurostat) was NOT independently verified here and conflicts with this project's own carefully verified figure for the same year and population (66.7%, EU-SILC's standard "great/some difficulty" cut) -- possibly a broader response-category cut of the same question, possibly an error in that article; it is flagged rather than relied on, and this project's own 66.7% figure is what should be cited, not the 86.2% one. Relationship to this project's own findings: this is a live instance of exactly the dynamic V2-1.2 and the narrative's opening describe -- aggregate indicators (deposit totals, card-spending averages) offered as evidence against reported hardship, without engaging the household-level, EU-SILC-based subjective-hardship measure this project uses (66.7%, EU's highest, 2024) or its own already-verified finding (CTX-9) that Greece's post-2019 wealth gains are heavily concentrated in the wealthiest quintile, not evenly spread across "the middle class." Not promoted to the context register: unlike X-02/X-03/X-04, this is a rebuttal of a public claim's own arithmetic, not new evidence independently corroborating this project's findings. | checked, not incorporated — informational only, no claim, context entry, or figure affected |
| X-06 | 2026-09-14 | A reader claim, relayed early in this project via a friend's Facebook post, that the Greek government changed how unemployment is calculated in recent years — raised again later by a detailed, well-sourced follow-up analysis (from a separate reviewing session) identifying the actual mechanism and disputing the implication of the original claim | The follow-up analysis's account checks out. **What actually changed**: EU Regulation 2019/1700 mandated a harmonized Labour Force Survey methodology across ALL EU member states from reference year 2021 — an EU-wide regulatory requirement, not a Greece-specific or politically directed change. Confirmed against ELSTAT's own methodological note ([statistics.gr](https://www.statistics.gr/documents/20181/f32fb3c5-abf9-6380-5ef0-c3fffeb02e3e)) and Eurostat's correction-methodology documentation ([Statistics Explained cache PDF](https://ec.europa.eu/eurostat/statistics-explained/SEPDF/cache/94764.pdf)). Rather than leave a break at the 2020/2021 boundary, ELSTAT and Eurostat retroactively revised the Greek series back through 2009 under the harmonized definitions, so the `une_rt_a` series this project already uses (`scripts/03_fetch_supplementary.py`, `unemployment_rate` spec, dataset `une_rt_a`, age `Y15-74`) is a single continuous harmonized vintage, not a legacy series spliced onto a revised one. **Independently verified against this project's own data**, not just accepted on the follow-up's say-so: `data/raw/panel_unemployment_history.csv`, `geo=EL`, gives 2013 = 27.8% and 2020 = 17.6% — both match the harmonized/corrected figures the follow-up cites (vs. 27.5% and 16.3% pre-revision), confirming this project's pipeline already pulls the current, corrected vintage throughout, with no manual use of a pre-revision series anywhere. **The direction refutes the original claim**: the harmonized series shows HIGHER historical Greek unemployment than the pre-2021 vintage in every year checked, the opposite of what "the government changed the calculation" implied when first raised. **Effect on this project's own cumulative-unemployment construct** (card 5 of the carousel, `cum_excess_unemployment`, summing each year's excess over each country's own 2009 level): because the harmonized series runs continuously from 2009 with no vintage change partway through, the accumulation carries no internal discontinuity from the 2021 correction. Full technical documentation added to `docs/comparability_notes.md` (new section, "Unemployment rate — 2021 EU-wide methodology harmonization"); a brief reader-facing transparency note added to the narrative near the cumulative-unemployment section, and a one-line note added to carousel card 5 in both languages. | checked; documented in `docs/comparability_notes.md` and a narrative transparency note — not promoted to the context register (data-comparability documentation, not incremental corroborating evidence for a poverty finding) |
